...
![Horse populations for all provinces in Canada from 1906 - 1972.](../results/horse_pops_plot.png){#fig-pop width=75%}
...
In @fig-largest-sd we zoom in and look at the province of `{python} largest_sd`, 
